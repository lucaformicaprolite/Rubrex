...
router.get('/api/cuenta-corriente', autenticar, async (req, res) => {
  try {
...
router.get('/api/cuenta-corriente/:clienteId', autenticar, async (req, res) => {
  try {
    const rows = await db.prepare(`
...
router.post('/api/cuenta-corriente', autenticar, async (req, res) => {
  try {
...
router.get('/api/gastos', autenticar, async (req, res) => {
  try {
...
router.get('/api/caja/estado', autenticar, async (req, res) => {
  try {
...
router.get('/api/caja/historial', autenticar, async (req, res) => {
  try {
    const rows = await db.prepare(`
...
router.get('/api/cheques', autenticar, async (req, res) => {
  try {
...
router.get('/api/notas-cd', autenticar, async (req, res) => {
  try {
