...
// ⚠️ AJUSTAR ESTOS PRECIOS cuando los tengas definidos.
// (son los mismos que se muestran en la landing, en la sección de precios)
const PLANES = {
  intermedio: { nombre: 'Rubrex - Plan Intermedio', precio: 6999 },
  pro: { nombre: 'Rubrex - Plan Pro', precio: 12999 }
};
