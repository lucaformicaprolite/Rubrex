...
async function procesarOrdenEntrante(integracionRow, ordenNormalizada) {
  ...
  try {
    ...
    const ventaRes = await client.query(
      `INSERT INTO ventas (negocio_id, items, total, metodo_pago, cliente_nombre, factura, sin_cae, origen, external_order_id, comprador)
      ...
      [
        ...
        ordenNormalizada.external_order_id || null,
        ordenNormalizada.cliente ? JSON.stringify(ordenNormalizada.cliente) : null
      ]
    );
